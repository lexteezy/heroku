...
//6dd32a74-9045-42f3-8796-02bb32573fbe API KEY
  ...
  const getNodacPrice = async() => {
    const avaxBalance = ethers.utils.formatUnits(await wavaxContract.balanceOf("0xE175bd0B421331BfA06E619b77A022Ec98899aC3"), 18);
    const nodacBalance = ethers.utils.formatUnits(await nodacContract.balanceOf("0xE175bd0B421331BfA06E619b77A022Ec98899aC3"), 18);
